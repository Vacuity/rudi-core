...
/**
 * Simple example that demonstrates how to use
 * <a href="code.google.com/p/google-http-java-client/">Google HTTP Client
 * Library for Java</a> with the
 * <a href="https://developers.google.com/+/api/">Google+ API</a>.
 *
 * <p>
 * Note that in the case of the Google+ API, there is a much better custom
 * library built on top of this HTTP library that is much easier to use and
 * hides most of these details for you. See <a href=
 * "http://code.google.com/p/google-api-java-client/wiki/APIs#Google+_API">
 * Google+ API for Java</a>.
 * </p>
 *
 * @author Yaniv Inbar
 */
public class GoogleAPISample {
