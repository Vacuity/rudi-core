...
2. **Accountability** - with the exception of nodes at the user-facing sensory surface, a worker pool node exposes the identity of its owner in a manner that is non-repudiable, as a condition to joining the worker pool. Each worker pool assigns nodeIds differently.
